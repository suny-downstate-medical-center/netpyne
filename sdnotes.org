...
*** trying new set of params from gen138_cand93 (0.08, 0.11)
...
- THINGS TO TRY NEXT:
-- something ot increase L2 inh spikes
-- longer training times to increase weight difference -> mov amplitude
-- increasing EB5 inputs during testing without increasing overall background rate - eg. PMd inputs? only background EB5 netstims?
