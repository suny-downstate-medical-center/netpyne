...
netParams.popParams['E1'] = {'cellType': 'E', 'numCells': 3000, 'cellModel': 'VecStim', 'rate': 100, 'noise': 0.5}
netParams.popParams['E2'] = {'cellType': 'E', 'numCells': 3000, 'cellModel': 'VecStim', 'rate': 100, 'noise': 0.75}
netParams.popParams['E3'] = {'cellType': 'E', 'numCells': 3000, 'cellModel': 'VecStim', 'rate': 100, 'noise': 1.0}


#netParams.popParams['E2'] = {'cellType': 'E', 'numCells': 200, 'yRange': [100,300], 'cellModel': 'HH'}
# netParams.popParams['I2'] = {'cellType': 'SOM', 'numCells': 200, 'yRange': [100,300], 'cellModel': 'HH_simple'}
# netParams.popParams['E4'] = {'cellType': 'E', 'numCells': 5, 'yRange': [300,600], 'cellModel': 'HH'}
# netParams.popParams['I4'] = {'cellType': 'PV', 'numCells': 200, 'yRange': [300,600], 'cellModel': 'HH_simple'}
# netParams.popParams['E5'] = {'cellType': 'E', 'numCells': 5, 'ynormRange': [0.6,1.0], 'cellModel': 'HH'}
# netParams.popParams['I5'] = {'cellType': 'SOM', 'numCells': 200, 'ynormRange': [1.0,2.0], 'cellModel': 'HH_simple'}
...
# netParams.stimTargetParams['bkg->all'] = {'source': 'bkg', 'conds': {'cellType': ['E','PV', 'SOM']}, 'weight': 10.0, 'sec': 'dend', 'delay': 'max(1, normal(5,2))', 'synMech': 'exc'}
...
#simConfig.analysis['plotRaster'] = {'timeRange': [0, 100], 'popRates':1, 'orderBy': ['pop','y'], 'orderInverse': True, 'saveFig':True, 'figSize': (9,3)}      # Plot a raster
