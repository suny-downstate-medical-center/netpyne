...
STDPparams = {'hebbwt': 0.00001, 'antiwt':-0.00001, 'wmax': 50, 'RLon': 1 , 'RLhebbwt': 0.001*0, 'RLantiwt': -0.001*0, \
...
simConfig['seeds'] = {'conn': 3, 'stim': 3, 'loc': 3} # Seeds for randomizers (connectivity, input stimulation and cell locations)
