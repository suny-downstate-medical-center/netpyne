...
def addStims(self):
    ...
    Usage:
        Creates and attaches stims to targets via CompartCell.addstim() based on entries in the specs.NetParams()
        ...
        'type' entry (i.e. 'IClamp', 'VClamp', 'SEClamp', 'AlphaSynapse')
