...
**** TODO plot weightchanges 
** TODO add interface to musculoskel arm (currently dummyArm)
...
*** TODO make ASC=NSLOC and check if can have plasticity
** TODO Add the training, testing, and analysis functions
** TODO decide where plasticity will happen restrict learning to that subset of pops
