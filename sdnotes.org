...
* 15mar19 checking izhi traces and adding new izhi demo to modeldb
...
** Found another bug in cliff implementation (b sign)
...
b should be neg else all same
*** comparison of m1ms model after change
before:
  Run time: 9.1 s (16-s sim; 1 scale; 1064 cells; 8 workers)
  Spikes: 221212 (12.99 Hz)
  Connections: 16803 (7381 STDP; 15.79 per cell)
  Mean connection distance: 1133.21 um
  Mean connection delay: 15.21 ms
  Plotting raster despite using too many cores (8)
  Done; time = 4.1 s
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_190051.png][fig]]

after:
  Run time: 9.1 s (16-s sim; 1 scale; 1064 cells; 8 workers)
  Spikes: 228569 (13.43 Hz)
  Connections: 16803 (7381 STDP; 15.79 per cell)
  Mean connection distance: 1133.21 um
  Mean connection delay: 15.21 ms
  Plotting raster despite using too many cores (8)
  Done; time = 3.9 s
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_190109.png][fig]]

- significant changes in background activity

- going to try changing also LTS b to negative:
def lowthreshold(section, C=100, k=3, vr=-56, vt=-42, vpeak=40, a=0.03, b=-8, c=-50, d=20, celltype=3, cellid=-1):

  Run time: 9.3 s (16-s sim; 1 scale; 1064 cells; 8 workers)
  Spikes: 228569 (13.43 Hz)
  Connections: 16803 (7381 STDP; 15.79 per cell)
  Mean connection distance: 1133.21 um
  Mean connection delay: 15.21 ms
...
no apparent effect; raster looks identical to above after.

*** check these params in izhi matlab code from book
- using the -b, RS and FS neurons respond to I=70; but using b they dont
- if increase to I=170, both -b and b fire, but -b has higher rate
- so the -b seems to have effect of lowering firing threshold

figs (left=using b, right=using -b, top=v, bottom=u)
I=70:
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_192635.png][fig]]

I=90:
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_192742.png][fig]]

I=150:
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_192900.png][fig]]

I=400:
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_193039.png][fig]]

f-I curve
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150326_194908.png][fig]]

** Tested i-F curve in cliff model
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150327_142320.png][fig]]
/u/salvadord/Documents/ISB/Models/m1ms/sim/izhitest.py
** Trying to fix Izhi demo GUI for modeldb
*** chat with bill
/u/billl/nrniv/m1sim/izh.py can you fix this thing? -- then i can post -- if can make it show a traj that is in the izhi book
i have an Iin as the final param:
typeB = collections.OrderedDict([
# C k vr vt vpeak a b c d celltype, Iin
('pyramidal', (100, 3, -60, -50, 30, 0.01, 5, -60, 400, 1, 200)),
('fastspiking', (20, 1, -55, -40, 25, 0.15, 8, -55, 200, 2, 200)),
('lowthreshold', (100, 3, -56, -42, 40, 0.03, 8, -50, 20, 3, 200)),
('thalamocortical', (200, 0.5, -60, -50, 40, 0.10, 0, -60, 10, 4, 200)),
('reticular', (40, 0.25, -65, -45, 0, 0.015, 10, -55, 50, 5, 200))])

thanks -- please ask questions --- robert helped me fix this up -- just the button stuff is pretty complicated
python -i izh.py
winup('Networking model') # brings up the cliff parameters

if change the params -- eg Iin -- after run the first time then just hit run button (or do h.run() ) so don't reset the params back to where they started
also has I0 and I1 to do an initial hyperpolarization
*** obtaining reference traces to reproduce from 2007 Book
**** RS pyramidal (L4 or L5)
- fig8.12 p283
- 200ms = 135 pixels
- duration of stimulus = 680-338 px = 500 ms
...
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150327_161803.png][fig]] 
[[file+sys:/u/salvadord/Documents/ISB/Models_linux/m1ms/gif/20150327_161955.png][fig]]

** Consolidating model and updating modeldb
*** consolidating in /usr/site/nrniv/local/sim/izhikevich
no% cat convert_filemap.txt 
exclude "."
include "izh.py"
include "izhi.py"
rename "izh.py" "izhiGUI.py"
rename "izhi.py" "izhiWrapper.py"

hg convert --filemap convert_filemap.txt /u/salvadord/Documents/ISB/Models/m1sim izhikevich

scp /u/salvadord/Models_linux/m1ms/sim/izhitest.py izhi2007Figs.py

no% pwd
/usr/site/nrniv/local/mod
no% hg log -l2
changeset:   723:50cc319a055c
tag:         tip
user:        salvadord
date:        Mon Mar 30 15:20:47 2015 -0400
summary:     renamed Izh1.mod izhi2003b.mod

changeset:   722:f32ae5d12a19
user:        salvadord
date:        Mon Mar 30 14:43:17 2015 -0400
summary:     renamed old izh.mod to izhi2003.mod; and added new izhi model from 2007 book to izhi2007.mod
...
* 15mar28 Updated izhi cell types - trying to restore decent network behavior
** params 
- need to increase I activity
    s.backgroundweightExplor = 2
    s.backgroundweight = 1.0*array([1,0.1]) # Weight for background input for E cells and I cells
    s.connweights[s.IDSC,s.EDSC,s.GABAA]=0.5 
    s.scaleconnweight = 1.0*array([[2, 1], [2, 0.1]]) # Connection weights for EE, EI, IE, II synapses, respectively
    s.backgroundweight = 1.0*array([1,0.3])
    s.connweights[s.PMd,s.ER5,s.AMPA]=2.0

- s.scaleconnweight = 1.0*array([[2, 2], [2, 0.5]])

- s.backgroundweight = 1.0*array([1,0.6]) - lead to increase in I

-     s.backgroundweight = 1.0*array([1,1]) - no osc

- s.backgroundweight = 1.0*array([1,0.5]) - no osc

- s.backgroundweight = 1.0*array([1,1]) #

- use evo to tune firing rate and psd??
