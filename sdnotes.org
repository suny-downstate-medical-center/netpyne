...
**** right target consistently better
...
-- having issue with NSLOCs-- doesnt recognize some params -- cannot connect using netcon! compare with netstim.mod
...
*** TODO Reproducibility - use same random seeds
