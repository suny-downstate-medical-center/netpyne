...
STDPparams = {'hebbwt': 0.001, 'antiwt':-0.0013, 'wmax': 50, 'RLon': 1 , 'RLhebbwt': 10, 'RLantiwt': -2.5, 'tauhebb': 10, 'RLwindhebb': 50, 'useRLexp': 1, 'softthresh': 1}
...
simConfig['plotCells'] = ['Pel', 'Psh', 'ES', 'EM', 'IM', 'IS'] #, 'ES', 'IS', 'ISL', 'EM', 'IM', 'IML'] # plot recorded traces for this list of cells
simConfig['plotLFPSpectrum'] = True # plot power spectral density
