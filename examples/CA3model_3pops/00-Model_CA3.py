...
###############################################################################
netParams.stimSourceParams['IClamp_PYR'] =  {'type': 'IClamp', 'del': 2*Dt, 'dur': 1e9, 'amp': 50e-3}
netParams.stimSourceParams['IClamp_OLM'] =  {'type': 'IClamp', 'del': 2*Dt, 'dur': 1e9, 'amp': -25e-3}
...
###############################################################################
# to PYR
netParams.stimSourceParams['NetStim_PYR_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_NMDA'] = {'type': 'NetStim', 'interval': 100, 'number': int((1000/100.0)*Tfinal), 'start': 0, 'noise': 1}
...
# to BC
netParams.stimSourceParams['NetStim_BC_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_BC_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
# to OLM
netParams.stimSourceParams['NetStim_OLM_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_OLM_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000*Tfinal, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['Septal'] = {'type': 'NetStim', 'interval': 150, 'number': int((1000/150)*Tfinal), 'start': 0, 'noise': 0}
...
simConfig.analysis['plotLFP'] = {'includeAxon': False, 'figSize': (6,10), 'timeRange': [250,1250], 'saveFig': True} 
simConfig.analysis['plotRaster'] = {'saveFig': True}
simConfig.analysis['plotTraces'] = {'include': [0, 1, 800, 801, 1000, 1001], 'saveFig': True}  # Plot recorded traces for this list of cells
#simConfig.analysis['plotShape'] = {'includePre': ['all'],'includePost': [0,800,1000],'cvar':'numSyns','dist':0.7, 'saveFig': True}
