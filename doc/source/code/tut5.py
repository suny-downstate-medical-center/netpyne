...
netParams['popParams'].append({'popLabel': 'ES', 'cellType': 'PYR', 'numCells': 50, 'xnormRange': [0,1.0], 'ynormRange': [0,0.5], 'cellModel': 'HH'}) 
netParams['popParams'].append({'popLabel': 'IS', 'cellType': 'BAS', 'numCells': 50, 'xnormRange': [0,1.0], 'ynormRange': [0,0.5], 'cellModel': 'HH'}) 
netParams['popParams'].append({'popLabel': 'EM', 'cellType': 'PYR', 'numCells': 50, 'xnormRange': [0,1.0], 'ynormRange': [0.5,1.0], 'cellModel': 'HH'}) 
netParams['popParams'].append({'popLabel': 'IM', 'cellType': 'BAS', 'numCells': 50, 'xnormRange': [0,1.0], 'ynormRange': [0.5,1.0], 'cellModel': 'HH'}) 
...
netParams['synMechParams'].append({'label': 'exc', 'mod': 'Exp2Syn', 'tau1': 1, 'tau2': 5.0, 'e': 0})  # NMDA synaptic mechanism
netParams['synMechParams'].append({'label': 'inh', 'mod': 'Exp2Syn', 'tau1': 1, 'tau2': 5.0, 'e': -80})  # GABA synaptic mechanism
...
simConfig['plotCells'] = ['EM','ES']    # Plot recorded traces for this list of cells
